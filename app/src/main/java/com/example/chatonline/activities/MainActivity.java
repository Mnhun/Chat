...
import com.example.chatonline.adapters.RecentConversationsAdapter;
import com.example.chatonline.databinding.ActivityMainBinding;
import com.example.chatonline.listeners.ConversionListener;
...
public class MainActivity extends AppCompatActivity implements ConversionListener {
    ...
    private void updateToken(String token){
        ...
        documentReference.update(Constants.KEY_FCM_TOKE, token)
    ...
    private void signOut(){
        ...
        updates.put(Constants.KEY_FCM_TOKE, FieldValue.delete());
